...
- It selects from the population (P) an individual, weighted by the fitnesses (P_fitness)
- It returns the selected individual
"""
def select_individual():
    return random.choices(P, weights = P_fitness, k = 1)[0] 
...
- The mutation protocol swaps two elements and returns the new individual if a mutation does occur
- Otherwise, it returns the input individual
"""
def mutate(x):
